...
\addthumb{Implementierung}{\huge{\textbf{\thechapter.}}}{white}{haw_rot} 
...
\centering
\fbox{
\subfigure[Darstellung der beiden Richtungsvektoren der Bildebene und zugehörige Normale $\vec{r} \times \vec{c}$]{\includegraphics[width=0.31\textwidth]{./img/normalenvektor.pdf} \label{sort:single}} \hspace{0.2cm}
\subfigure[Schichten entlang der Normalen $\vec{r} \times \vec{c}$]{\includegraphics[width=0.31\textwidth]{./img/normalenvektorstack.pdf}\hfill \label{sort:stack}} \hspace{0.2cm}
\subfigure[Sortierung erfolgt durch Bestimmung der dominanten Achse]{\includegraphics[width=0.31\textwidth]{./img/dominantindex.pdf} \label{sort:dominant}}
}
...
\centering
\fbox{
\subfigure[Axiale Ansicht - $(x,y)$]{\includegraphics[width=0.31\textwidth]{./img/axial_xy.pdf} \label{layers:axial}}
\subfigure[Coronale Ansicht - $(x,z)$]{\includegraphics[width=0.31\textwidth]{./img/coronal_xz.pdf} \label{layers:coronal}}
\subfigure[Sagittale Ansicht - $(y,z)$]{\includegraphics[width=0.31\textwidth]{./img/sagittal_yz.pdf} \label{layers:sagittal}}
}
...
\begin{figure}[htbp]
  \vspace{0.5cm}
  \centering
  \fbox{\includegraphics[angle=0,width=0.75\textwidth]{./img/imageprocess.pdf}}
...
\centering
\fbox{
\subfigure[Rekonstruktion von der axialen zur coronalen Ebene]{\includegraphics[width=0.48\textwidth]{./img/axialcoronalmpr.pdf} \label{mpr:ac}}\hspace{0.2cm}
\subfigure[Rekonstruktion von der axialen zur sagittalen Ebene]{\includegraphics[width=0.48\textwidth]{./img/axialsagittalmpr.pdf} \label{mpr:as}}
}
...
\centering
\fbox{
\subfigure[Richtungsvektoren der axialen Bildebene werden um 90$^\circ$ um die x-Achse gedreht]{\includegraphics[width=0.4\textwidth]{./img/rotation.pdf} \label{rota:a}} \hspace{0.5cm}
\subfigure[Richtungsvektoren in coronaler Ausrichtung]{\includegraphics[width=0.4\textwidth]{./img/rotationc.pdf} \label{rota:c}}
}
...
\begin{figure}[htbp]
  \vspace{0.5cm}
  \centering
  \fbox{\includegraphics[angle=0,width=0.6\textwidth]{./img/movetool.pdf}}
